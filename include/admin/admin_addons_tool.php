...
class admin_addons_tool{
	var $rate_testing = true; //for testing on local server
	...
	function GetAvailInstall($fullPath){
		...
		if( !$array || !isset($array['Addon_Name']) ){
			return false;
		}		
	...
	function CanRate(){
		...
		if( empty($_SERVER['HTTP_HOST']) ){
			$this->messages[] = 'PHP is not assigning a value to $_SERVER[\'HTTP_HOST\'].';
		}
	...
	function GetAddonRateInfoTheme($arg){
	...
	function PingRating($data){
		...
		//message('hmm: '.showArray($contents));
